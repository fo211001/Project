#-*- coding: utf-8 -*-
from all_chords import get_tone, get_modif, tones_indexed, normal_view


def semitone_distance(first_chord, second_chord):
    "Возвращаем число полутонов от первого до 2-го аккорда"
    return (tones_indexed[get_tone(normal_view(second_chord))]
            - tones_indexed[get_tone(normal_view(first_chord))]) % 12
